defmodule KubatanaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KubatanaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KubatanaWeb.Gettext, "errors", msg, opts)
    end
  end
